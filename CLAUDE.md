...
This project is indexed by GitNexus as **notify-hub** (4377 symbols, 12347 relationships, 267 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/notify-hub/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/notify-hub/context` | Codebase overview, check index freshness |
| `gitnexus://repo/notify-hub/clusters` | All functional areas |
| `gitnexus://repo/notify-hub/processes` | All execution flows |
| `gitnexus://repo/notify-hub/process/{name}` | Step-by-step execution trace |
