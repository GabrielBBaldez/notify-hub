...
public class SendMailgunTool {

    private final NotifyHub notifyHub;

    public SendMailgunTool(NotifyHub notifyHub) {
    ...
    private CallToolResult execute(Map<String, Object> args) {
        ...
        NotificationBuilder builder = notifyHub.to(recipient).via(Channel.MAILGUN);
        ...
        return ToolResultHelper.success("Mailgun email sent", Map.of(
                "id", receipt.getId(),
