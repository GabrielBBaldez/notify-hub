...
public class SendNotionTool {

    private final NotifyHub notifyHub;

    public SendNotionTool(NotifyHub notifyHub) {
        ...
        String schema = """
                {
                  ...
                  "properties": {
                    "recipient": {
                      "type": "string",
                      "description": "Notion recipient alias (configured name) or database ID"
                    },
                    "subject": {
                      "type": "string",
                      "description": "Page title (defaults to 'Notification')"
                    },
                    "body": {
                      "type": "string",
    ...
    private CallToolResult execute(Map<String, Object> args) {
        ...
        NotificationBuilder builder = notifyHub.to(recipient != null ? recipient : "default").via(Channel.NOTION);
        ...
        return ToolResultHelper.success("Notion page created", Map.of(
                "id", receipt.getId(),
