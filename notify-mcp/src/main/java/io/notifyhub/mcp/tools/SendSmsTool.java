...
public class SendSmsTool {
    ...
    public SendSmsTool(NotifyHub notifyHub) {
    ...
    private CallToolResult execute(Map<String, Object> args) {
        ...
        NotificationBuilder builder = notifyHub.toPhone(phone).via(Channel.SMS);
        ...
        return ToolResultHelper.success("SMS sent to " + phone, Map.of(
                "id", receipt.getId(),
