...
public class SendTikTokShopTool {

    private final NotifyHub notifyHub;

    public SendTikTokShopTool(NotifyHub notifyHub) {
    ...
    public SyncToolSpecification specification(McpJsonMapper jsonMapper) {
        String schema = """
                {
                  ...
                  "properties": {
                    "recipient": {
                      "type": "string",
                      "description": "TikTok Shop recipient alias or shop ID"
                    },
                    "body": {
                      "type": "string",
        ...
        Tool tool = Tool.builder()
                .name("send_tiktok_shop")
                .description("Send a TikTok Shop notification via TikTok Shop API.")
    ...
    private CallToolResult execute(Map<String, Object> args) {
        ...
        String target = recipient != null ? recipient : "default";
        NotificationBuilder builder = notifyHub.to(target).via(Channel.TIKTOK_SHOP);
        ...
        return ToolResultHelper.success("TikTok Shop notification sent", Map.of(
                "id", receipt.getId(),
